...
\S\S\ref{sec:substance}--\ref{sec:rct-phil} stands independently of how
...
defense.
We are not reading quantum mechanics retroactively into a religious text
written before the formal physics existed.
We are recognizing that two traditions, working in different vocabularies,
...
The objection dissolves once we distinguish two senses in which an
...
see also \citealt{Griffin2000} for an explicitly Whiteheadian treatment
