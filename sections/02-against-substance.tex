...
available; we address it directly in \S\ref{sec:objections} below and argue
...
On our reading, the measurement event in Rovelli's framework is the moment
...
This is, on our reading, precisely the structure that process ontology predicts.
...
Bohm does not refute the relational reading of quantum mechanics; he
formalizes one version of it, with the additional commitment to point
particles whose positions do no explanatory work the wave function does
not already do.
...
mechanics that survives the experimental record either is a process
ontology (relational quantum mechanics, Whiteheadian readings) or
collapses, on examination, into a relabeled version of one (Bohmian
mechanics as a nonlocal relational field; many-worlds as branching
relational structure within each branch; QBism as a relational
