...
The conclusion, on the reading defended here, is that local substance
ontology is not merely one alternative interpretation among others but
an interpretation the formal theorem and its experimental confirmation
have made untenable; the surviving nonlocal substance-style reading
(Bohmian mechanics), I argue, preserves the label of ``substance'' only
by importing the relational structure substance ontology was originally
meant to avoid --- a reading of Bohm's ontology that is contested (see
\S\ref{sec:objections}) and is this paper's own interpretive claim, not
a further consequence Bell's theorem itself forces.
...
further: under a preparation-independence assumption standard in the
literature but rejected by retrocausal and superdeterministic models, the
quantum state cannot be a state of knowledge about an underlying ontic
state with definite properties shared by distinct quantum states; the
wave function must itself be ontic.
