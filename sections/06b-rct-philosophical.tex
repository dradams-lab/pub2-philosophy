...
The companion's simulation results identify $\theta = \pi/8$ --- half the
gate duration of \textsc{iswap} --- as the operationally optimal point
under realistic decoherence, with a fidelity advantage over \textsc{iswap}
of $\Delta F \in [{+0.019},\,{+0.020}]$ at per-gate error rate
