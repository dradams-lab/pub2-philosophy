...
before \textit{Process and Reality} and (in the Bahá'u'lláh corpus on
which 'Abdu'l-Bahá here builds) more than half a century before it.
...
on 'Abdu'l-Bahá's account, passes into nonexistence: not into nothingness,
...
theorem by half a century to a century, depending on which Bahá'í
