...
instruments''~\citep[para.~35]{SummonsLordHosts}.
...
On my reading, the nonlocality of quantum entanglement is, in process
...
I read this connectedness as not merely metaphorical or spiritual.
On my reading, it is an ontological claim about the structure of existence:
...
its environment).
In the framework of the Relational Coherence Framework, the Affinity Operator
...
I present the convergence because the structural parallel ---
...
\paragraph{Process philosophy.}
On my reading, Whitehead's account of prehension exhibits the essential
structural feature that Bohm's implicate order would later
formalize~\citep{Whitehead1929}: every actual occasion, through its
prehension of prior occasions, carries within itself the inherited
character of the entire causal past.
...
On my reading, this is the process ontological analogue of the holographic
principle: the information of the whole is available in every part because
every part is constituted by prehensive relations that reach across the
causal past.
...
On my ontological reading of this passage, the claim is structurally
holographic: the whole --- the creative ground of existence --- is
present in each of its expressions.
% NOTE: original draft contained a quote attributed to SelectionsAbdul
...
% Selections, PUP, Travellers, or via bahai.org search. Replaced below
% with a verified passage making the structurally equivalent point (one
% indivisible reality, manifold expressions through diverse instruments),
% traced to its primary source: The Summons of the Lord of Hosts, para.
% 35 (Baha'i Reference Library, reference.bahai.org/en/t/b/SLH/slh-10.html).
...
through the diversity of its instruments.''~\citep[para.~35]{SummonsLordHosts}
...
I flag this convergence, like Convergence 5, as closer to the analogical
end of the paper's spectrum: the uncertainty principle's prohibition on
simultaneous definite position and momentum is a precise physical claim
about non-commuting observables, while ``motion is life\ldots\ inert is
dead'' is, on its face, a normative or vitalist claim about biological
and spiritual vitality rather than a claim about momentum.
Treating these as expressing ``the same structural insight'' requires
reading the \bahai passage at a level of abstraction (constitutive
dynamism as opposed to static being) at which the physical and the
vitalist senses of ``motion'' are no longer obviously the same sense of
the word; the convergence is real at that level of abstraction, but the
abstraction is doing more work here than in Convergences 1--4.
