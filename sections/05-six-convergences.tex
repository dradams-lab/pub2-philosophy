...
actual entity~\citep[ch.~III, esp. p.~50]{Whitehead1929}, in the sense
that each occasion's becoming incorporates, through prehension, the
entire objective past.
...
human body''~\citep[§21]{SelectionsAbdul}.
...
The Bahá'í decomposition claim concerns the dissolution of a thing's
...
The same structural point is made in Bahá'u'lláh's own writings.
...
through the diversity of its instruments.''~\citep[§13.5]{BSW}
