...
1964        & Bell's theorem: formal proof that no local hidden-variable theory
            ...
            & Physics \\
1982        & Aspect's experiments \citep{Aspect1982} confirm Bell inequality
              violations; time-varying analyzers \citep{AspectDalibardRoger1982}
              substantially address the locality loophole
            & Physics \\
...
a quantitative object (the Affinity Operator~$\alpha$), a testable two-qubit
